package vbm.medrelais.security.configuration;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/v3/api-docs/**",
                                "/v3/api-docs"
                        ).permitAll() // Documentation Swagger accessible sans authentification
                ...
                .exceptionHandling(exceptions -> exceptions
                        // Token absent, expiré ou invalide → 401
                        ...
                        // Token valide mais droits insuffisants → 403
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            response.setStatus(HttpStatus.FORBIDDEN.value());
                            response.setContentType("application/json;charset=UTF-8");
                            response.getWriter().write(
                                    "{\"typeError\":\"ACCESS_DENIED\",\"message\":\"Accès refusé : droits insuffisants\"}"
                            );
                        })
                )
